  ...
  #      else:
   #         return SOMETHING
    ...
    def parsedata(self, package):
        ...
        package_correct_order= np.squeeze(package_correct_order)
    ...
    def tone(self, frequency, duration_ms):
        ...
        try: 
            ...
            print('sounddevice module is needed for method tone')
        
        print('Tone: frequency = %.1f Hz, duration = %.1f ms' % (frequency, duration_ms))
        return        